...
class TestAddressBook(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.assertEqual(self.address_book.contacts[0].first_name, "Tom")
        self.assertEqual(self.address_book.contacts[0].last_name, "Smith")
        self.assertEqual(self.address_book.contacts[0].middle_name, "")
        self.assertEqual(self.address_book.contacts[0].birthday, "01.Dec.2020")
        self.assertEqual(self.address_book.contacts[0].tel_number, "093420841")
        self.assertEqual(self.address_book.contacts[0].email, "Tom.Smith@gmail.com")

        # Check if the success message is printed
        expected_output = "Contact was successfully added."
    ...
    def test_delete_contact(self):
        ...
        self.address_book.contacts.append(contact)
